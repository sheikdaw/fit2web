                        ...
                        <div class="header-left">
                            <div class="logo">
                                <a href="index.html" class="header-logo">
                                    <img src="assets/images/logo/itekHeaderLogo.png" alt="logo-img">
                                </a>
                            </div>
                        </div>
                                                ...
                                                <ul class="submenu has-homemenu">
                                                    <li>
                                                        <div class="homemenu-items">
                                                            ...
                                                            <div class="homemenu">
                                                                <div class="homemenu-thumb mb-15">
                                                                    <img src="assets/images/header/home-4.png"
                                                                        alt="img">
                                                                    <div class="demo-button">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="service_content_info_item2 wow fadeInUp" data-wow-delay=".3s">
                                ...
                                <div class="btn-wrapper">
                                    <a href="services.html" class="theme-btn"> View All <i
                ...
                <div class="container">
                    <div class="about_content">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5">
                                <div class="client_content_img img-custom-anim-right wow fadeInUp"
                                    data-wow-delay=".4s">
